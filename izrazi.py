...
def barvanje(v,e,k):
    """v je stevilo vozlisc, e je mnozica povezav, podana z incidencno matriko, k je stevilo barv."""
    n=v
    
    for i in range (1,n+1):
        i1=Or("C_{0}1".format(i),"C_{0}2".format(i),"C_{0}3".format(i))
    for i in range(1,n+1):
        And(Not(And("C_{0}1".format(i),"C_{0}2".format(i)),Not(And("C_{0}1".format(i),"C_{0}3".format(i)),Not(And("C_{0}2".format(i),"C_{0}3".format(i)))
